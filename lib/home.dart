...
var scaffoldkey=GlobalKey<ScaffoldState>();
  ...
  Widget build(BuildContext context) {
                     ...
                     // height: MediaQuery.of(context).size.height/16,
                      ...
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                            ...
                            children: [
                              Text('Calculate Your Body...',style: TextStyle(color: Colors.white,fontSize: 16),),
                            ],
                          ),
    ...
    drawer: Drawer(backgroundColor: const Color.fromARGB(255, 255, 255, 255),child: Container(),
